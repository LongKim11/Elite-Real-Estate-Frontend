        ...
        <div className="flex min-h-screen flex-col gap-8 px-4 py-6 md:px-12 lg:flex-row">
            ...
            <div className="flex-[3] overflow-y-auto">
                ...
                <div className="mt-8">
                    ...
                    {/* Property Description - Blue Theme */}
                    <div className="mt-6 rounded-xl border border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100/30 p-6 shadow-md transition-all duration-300 hover:shadow-lg">
                        {/* Header */}
                ...
                <div className="mt-8">
                    ...
                    <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="flex items-center gap-4 rounded-xl border border-purple-200 bg-gradient-to-br from-purple-50 to-purple-100 p-4 shadow-sm transition-all duration-300 hover:shadow-md">
                            <div className="rounded-full bg-purple-200 p-3 shadow-inner">
                    ...
                    {property.category === 'House' && (
                        <div className="mb-8 rounded-lg border bg-white p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-2 gap-6 md:grid-cols-3">
                                ...
                                <div className="flex items-center gap-3">
                                    <TreeDeciduous className="text-amber-500" />
                                    <div>
                                        <div className="text-sm text-gray-500">
                                            Garden
                                        </div>
