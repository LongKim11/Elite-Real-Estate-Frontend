...
public class ApartmentSpecs {
    ...
    public static Specification<Apartment> withFilter(PropertySearchFilter filter, boolean isAdmin) {
        return (root, query, cb) -> {
            ...
            // So sánh expire_time với ngày hiện tại (ngày hôm nay)
            if (!isAdmin) {
                Date today = new Date();
            ...
            Join<Apartment, ImageStorage> imageJoin = root.join("images", JoinType.LEFT);
