...
public class LandSpecs {

    public static Specification<Land> withFilter(PropertySearchFilter filter , boolean isAdmin) {
        return (root, query, cb) -> {
            ...
            Join<Land, ImageStorage> imageJoin = root.join("images", JoinType.LEFT);
